...
class Solution:
    def stoneGameIX(self, stones: List[int]) -> bool:
        ...
        def win(count, total_sum, person):
            if sum(count) == 0:
                if person == 1: #bob
                    return True
                if person == 0: #Alice
            ...
            if count[0] > 0:
                count[0] -= 1
                return not win(count, total_sum, 1-person)
            
            if total_sum%3 == 1:
                if count[1] > 0:
                    count[1] -= 1
                    return not win(count, total_sum+1, 1-person)
                else:
                    return False
            ...
            if total_sum%3 == 2:
                if count[2] > 0:
                    count[2] -= 1
                    return not win(count, total_sum+2, 1-person)
                else:
                    return False
