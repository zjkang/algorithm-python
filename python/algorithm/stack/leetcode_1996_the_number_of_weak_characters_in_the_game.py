...
note: 使用russian roll的类似方法排序，维持单调递减栈维护不符合weak characters的元素
...
than this character's attack and defense levels. More formally, a character i is said to be weak 
